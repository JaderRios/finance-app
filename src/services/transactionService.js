...
export async function fetchTransactions(options = {}) {
  ...
  let query = supabase
    .from('transactions')
    .select('id, account_id, category_id, amount, currency, amount_base, base_currency, description, date, type, created_at, categories(name, icon), accounts(name, currency)')
    .eq('user_id', user.id)
