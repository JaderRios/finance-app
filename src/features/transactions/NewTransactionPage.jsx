  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[440px_1fr]">
        ...
        <section className="rounded-[32px] border border-white/60 bg-[linear-gradient(180deg,#ffffff,#f7faff)] p-6 shadow-sm">
          <h3 className="text-2xl font-bold text-slate-900">Consejos rapidos</h3>
